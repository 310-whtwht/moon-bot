      ...
      const mockNotifications: Notification[] = [
        {
          ...
          message: 'EMA Cross strategy executed 5 trades successfully today with 80% win rate.',
          category: 'trading',
        ...
        },
        {
          ...
          message: 'Unusual volatility detected in AAPL. Consider reviewing position sizing.',
        ...
        },
        {
          ...
          type: 'info',
          title: 'Daily Summary',
          message: 'Daily trading summary: 12 trades, $1,250 P&L, 75% win rate.',
          category: 'performance',
        ...
        },
        {
          ...
          message: 'Daily drawdown approaching 2% limit. Consider reducing position sizes.',
          category: 'security',
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setSettings(prev => ({ ...prev, webhook: checked }))}
                  />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <Label htmlFor="performance">Performance Notifications</Label>
                  </div>
                  <Switch
                    id="performance"
                    ...
                    onCheckedChange={(checked) => setSettings(prev => ({ 
                      ...prev, 
                      categories: { ...prev.categories, performance: checked }
                    }))}
                  />
                </div>
              </CardContent>
            ...
            {settings.webhook && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Configure webhook endpoint for notifications</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
